...
def checkout(req: CheckoutRequest):
    ...
    for item in cart:
        order = {
            ...
            # Add other relevant fields if needed, but the assignment only strictly requires order_id, customer_name, product
        }
        orders.append(order)
        
    cart.clear() 
    return {"message": "Checkout successful", "grand_total": grand_total, "orders_placed": orders_placed}
