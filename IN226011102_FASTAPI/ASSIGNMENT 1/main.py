...
app = FastAPI(title="FastAPI Assignment 1")

# Initial Products List (Updated with Q1 requirements)
products = [
    ...
    {"id": 3, "name": "Pen Set", "price": 50, "category": "Stationery", "in_stock": True},
    {"id": 4, "name": "Monitor", "price": 15000, "category": "Electronics", "in_stock": True},
...
# Q1: Get All Products (Confirming total: 7)
@app.get("/products")
def get_products():
